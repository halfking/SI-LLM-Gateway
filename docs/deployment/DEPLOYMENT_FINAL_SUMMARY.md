...
**部署日期**: 2026-06-30  
**部署环境**: 生产环境 184服务器 (<prod-server-ip>)  
**状态**: ✅ 完全成功  
**执行者**: ZCode AI Agent
...
# 查看归档结果
PGPASSWORD='<your-password>' psql -h localhost -p 11032 -U llm_gateway -d llm_gateway -c "SELECT COUNT(*) FROM routing_decision_log_archive;"
```
