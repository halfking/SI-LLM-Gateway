...
export default {
  ...
  item: {
    ...
    examples: 'Exemples',
    chat: 'Chat',
    opsOverview: 'Vue d’ensemble ops',
    opsLicenses: 'Gestion des licences',
    opsDownloads: 'Versions et téléchargements',
    opsFaults: 'Gestion des incidents',
    opsAutoUpdate: 'Mise à jour auto',
    opsCenter: 'Ops centrales',
    opsVibeCoding: 'VibeCoding',
    opsProductEntry: 'Entrée produit',
  },
}
